...
<html>
    ...
    <div class="container">
        ...
        <table class="table table-condensed">
            ...
            <tr>
                <td>02/10/2015</td>
                <td><button type="button" class="btn btn-danger btn-xs">Cadastrar Cardápio</button></td>
            </tr>
            <tr>
                <td>03/10/2015</td>
                <td><button type="button" class="btn btn-danger btn-xs">Cadastrar Cardápio</button></td>
            ...
            <tr>
                <td>03/10/2015</td>
                <td><button type="button" class="btn btn-success btn-xs">consultar cardápio</button></td>
            </tr>
            <tr>
                <td>03/10/2015</td>
                <td><button type="button" class="btn btn-success btn-xs">consultar cardápio</button></td>
